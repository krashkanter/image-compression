...
class GridApp:
    def __init__(self, root):
        ...
        frame_grid_1.pack(side=tk.LEFT, padx=(0, 5))
        ...
        frame_grid_2.pack(side=tk.LEFT, padx=(5, 0))
    ...
    def apply_sharp(self):
        ...
        # for r in range(GRID_SIZE):
        #     for c in range(GRID_SIZE):
        #         state_from_grid_1 = self.compare_grid_1.grid_state[r][c]
        #         self.compare_grid_2._update_cell(r, c, state_from_grid_1)
